...
def test_create_reservation_rest(request_type):
    ...
    request_init["reservation"] = {'name': 'name_value', 'slot_capacity': 1391, 'ignore_idle_slots': True, 'concurrency': 1195, 'creation_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'multi_region_auxiliary': True}
...
def test_update_reservation_rest(request_type):
    ...
    request_init["reservation"] = {'name': 'projects/sample1/locations/sample2/reservations/sample3', 'slot_capacity': 1391, 'ignore_idle_slots': True, 'concurrency': 1195, 'creation_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'multi_region_auxiliary': True}
    request = request_type(**request_init)
